...
#ifndef CUT_SCENE_0_2
#define CUT_SCENE_0_2
...
class Cut_Scene_0_2
{
	...
	{
		"Hi, Artem!",
		"Listen, I thinked yesterday...",
		"And I understood...",
		"I have no Artemovich in friends, let`s change it!",
		"It is wery interesting, but I need proof...",
		"Bring to me a tooth of the Dragon!"
	};
