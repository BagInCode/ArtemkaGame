...
void Cut_Scene_1_2_2::makeSound(Music & music)
{
	/*
	* function loading and start the sound
	*/

	music.openFromFile("Music\\DragonFirstMetting.ogg");
	music.setLoop(1);
...
void Cut_Scene_1_2_2::makeSprites()
{
	/*
...
void Cut_Scene_1_2_2::drawDialog(RenderWindow & window)
{
	/*
...
void Cut_Scene_1_2_2::moveObjects(double timer)
{
	/*
...
bool Cut_Scene_1_2_2::switchEvent(Event event, RenderWindow & window, Music & music)
{
	/*
	...
	*/
	...
	if (event.type == Event::MouseButtonPressed && event.mouseButton.button == Mouse::Left)
	{
		...
		if (timerStay > WAITING_AFTER_END_OF_MOVING)
		{
			...
			if (dialogPointer == COUNT_MOUSE_CLICK_CUT_SCENE_1_2_2)
			{
				return 1;
			}
		}
...
void Cut_Scene_1_2_2::moveClouds(double timer)
{
	/*
...
void Cut_Scene_1_2_2::moveAlice(double timer)
{
	/*
...
void Cut_Scene_1_2_2::makeTextTTC()
{
	/*
...
void Cut_Scene_1_2_2::checkTime(RenderWindow & window)
{
	/*
...
void Cut_Scene_1_2_2::drawPicture(RenderWindow & window)
{
	/*
...
void Cut_Scene_1_2_2::play(RenderWindow & window, Music & music)
{
	/*
...
Cut_Scene_1_2_2::Cut_Scene_1_2_2()
{
}
