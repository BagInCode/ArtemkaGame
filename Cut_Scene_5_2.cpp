...
void Cut_Scene_5_2::makeSprites()
{
	/*
...
void Cut_Scene_5_2::drawDialog(RenderWindow & window)
{
	/*
...
void Cut_Scene_5_2::moveObjects(double timer)
{
	/*
...
bool Cut_Scene_5_2::switchEvent(Event event, RenderWindow & window, Music & music)
{
	/*
	...
	*/
	...
	if (event.type == Event::MouseButtonPressed && event.mouseButton.button == Mouse::Left)
	{
		...
		if (timerStay > WAITING_AFTER_END_OF_MOVING)
		{
			...
			if (dialogPointer == COUNT_MOUSE_CLICK_CUT_SCENE_5_2)
			{
				return 1;
			}
		}
...
void Cut_Scene_5_2::makeTextTTC()
{
	/*
...
void Cut_Scene_5_2::checkTime(RenderWindow & window)
{
	/*
...
void Cut_Scene_5_2::drawPicture(RenderWindow & window)
{
	/*
...
void Cut_Scene_5_2::play(RenderWindow & window, Music & music)
{
	/*
...
void Cut_Scene_5_2::moveAliceMom(double timer)
{
...
void Cut_Scene_5_2::moveClouds(double timer)
{
	/*
